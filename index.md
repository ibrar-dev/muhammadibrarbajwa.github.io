...
<html lang="en">
  ...
  <body>
      <nav class="navbar navbar-expand-md navbar-light bg-dark fixed-top"> 
          ...
          <button type="button" class="navbar-toggler bg-light" data-toggle="collapse" data-target="#nav"> <space class="navbar-toggler-icon"></space> </button>
          ...
          <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown" data-toggle="dropdown"><a class="nav-link text-light text-uppercase font-weight-bold px-3" href="#">Projects</a>
          ...
          <div class="container-fluid"> 
              <div class="row bg-info justify-content-center align-items-center"  style="height: 100vh">
                <div class="col-sm-10 text-center">
                    ...
                    <h2 class="font-weight-light font-italic text-light">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illo, velit? </h2>
                    <a href="#" class="btn btn-warning btn-lg m-3">Press Here </a>
                    <a href="#" class="btn btn-danger btn-lg m-3">Press Here </a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col text-center mb-3">
                            ...
                            <p class="lead text-secondary">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem eius voluptatem cum?</p>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col-lg-4 col-sm-10 mx-auto mb-5">
                            ...
                            <p class="text-muted my-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, nam sed neque repellat saepe magnam blanditiis? Sequi temporibus rem cumque?</p>
                        ...
                        <div class="col-lg-4 col-sm-10 max-auto mb-5"> 
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                         <div class="col-lg-3 col-sm-6">
                             <img src="img/project1.jpeg"  alt="Project1" class="img-thumbnail">
                             <h2 class="my-3 text-warning">Project One </h2>
                             <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, laudantium.</p>
                         </div>
              ...
              <div class="container-fluid">
                    <div class="row">
                            <div class="col text-center mb-3">
                                ...
                                <p class="lead text-light">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem eius voluptatem cum?</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-10 mx-auto mb-4">
                                <div class="card">
                                    <img src="img/team.jpeg" alt="Team" class="card-img-top">
                                    <div class="card-body">
             ...
             <div class="container">
                 <div class="row">
                     <div class="col text-center">
                         <h1 class="text-white font-weight-light p-3">Pure Bootstrap Project</h1>
                         ...
                         <div class="py-2">
                             ...
                             <a href="#" > <i class="fab fa-youtube fa-2x text-dnager mx-3"></i> </a>

                         </div>
                         <p class="text-light py-4 m-0"> &copy; Copyright 2019 - Made by -----</p>
                     </div>
                 </div>
             </div>
         </footer>
